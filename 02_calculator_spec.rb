...
describe "#multiply" do
  ...
  it "multiplies two other numbers, one of them being 0" do expect(multiply(7, 0)).to eq(0)
  end
end 

describe "#power" do
  it "raises one number to the power of another number" do expect(power(3, 2)).to eq(9)
end

  it "raises one number to the power of another number" do expect(power(5, 0)).to eq(1)
end

  it "raises one number to the power of another number" do expect(power(0, 5)).to eq(0)
end
end
